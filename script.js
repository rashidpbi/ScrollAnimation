...
animateAll({
  classes: [".s1", ".ad-1", ".cta-1", ".img-1", ".img-2", ".logo-1", ".dot-1"],
  svgDot: ".dotsfill1",
  trigger: ".slide-3",
  start: "top 105%",
  end: "top 50%",
...
animateAll({
  classes: [".s2", ".ad-2", ".cta-2", ".img-3", ".img-4", ".dot-2"],
  svgDot: ".dotsfill2",
  trigger: ".slide-3",
  start: "top 50%",
  end: "top 0%",
...
animateAll({
  classes: [".s4", ".ad-4", ".cta-4", ".img-10", ".dot-4"],
  svgDot: ".dotsfill4",
  trigger: ".slide-4",
  start: "top 50%",
  end: "top 0%",
...
animateAll({
  classes: [".s7", ".ad-7", ".cta-7", ".img-14", ".img-15", ".dot-7"],
  svgDot: ".dotsfill7",
  trigger: ".slide-6",
  start: "top 100%",
  end: "top -10%",
